pipeline {
    ...
    stages {
        ...
        stage('deploy') {
            steps {
                sh 'cd /home/jenkins/workspace/FleaCommerce/Terraform && terraform init && terraform fmt && terraform apply -auto-approve && kubectl apply -f ./home/jenkins/workspace/FleaCommerce/K8S/NopDeploy.yaml' 
